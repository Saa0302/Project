...
func main() {
	fmt.Println("Добро пожаловать в CalculatorRomArab \n" +
		"Правила использования:\n" +
		"1. Введите в одну строку два числа(либо только арабские, либо римские) и математический знак между ними.\n" +
		"2. Калькулятор поддерживает только 4 математических операции: '+', '-', '*', '/'.\n" +
		"3. Числа ограничены от 0 до 10 включительно.\n" +
		"4. Ответ: только целое число.\n" +
		"https://github.com/Saa0302/\n" +
		"\n\n" +
...
var errorDict = map[int]string{
	1: "Нераспознанные символы. Пожалуйста, используйте математические операторы '+', '-', '/', '*' только арабские/римские цифры и  ",
	...
	5: "Что-то пошло не так при вычислениях",
